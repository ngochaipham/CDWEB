...
<!DOCTYPE html>
<html lang="en">
<script src="/CDWebShop/nicEditor/nicEdit.js" type="text/javascript"></script>
<script type="text/javascript">
	bkLib.onDomLoaded(function() {
		//new nicEditor().panelInstance('description');
		new nicEditor({
			fullPanel : true,
			iconsPath : '/CDWebShop/nicEditor/nicEditorIcons.gif',
			uploadURI : '/CDWebShop/nicEditor/upload',
